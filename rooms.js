...
var rooms = {
	"start": {
	 ...
	 and the war chambers are to the <b>west</b>. Your expedition caravan is to the <b>east</b>.",
		"description2": "The temperature is " + temp + " Celsius",
		"directions": {
			"north": "throne_room",
			"west": "war_chambers",
			"east": "expeditions"
	...
	"war_chambers": {
		...
		"war_reports": {
			"description2": "Be prepared! The Kingdom of Yiraam has just declared attack on you! Their combat score is " + Yoriginal + ". Your combat score is " + Eoriginal, 
			"description3": "Your troops carry out a midnight raid. The Kingdom of Yiraam is unprepared for your attack! Their combat score is " + Yoriginal + ". Your combat score is " + Eoriginal,
